        ...
        computed:{
            notepad(){
                return this.$store.getters.getEventList.filter(d=>{
                    if(this.screen_type && !this.screen_title){
                        if(d.type === this.screen_type) return d;
                    }else if(this.screen_type && this.screen_title){
                        if(d.type === this.screen_type && d.content.indexOf(this.screen_title) > -1) return d;
                    }else if(!this.screen_type && !this.screen_title){
                        if(d.content.indexOf(this.screen_title) > -1) return d;
                    }else {return d}
                })
            },
            getTypeName(){
